...
describe('mithrilify', function() {
    ...
    it('should detect Mithril view files using .js file extension',
        function(done) {
    ...
    it('should detect Mithril view files using .msx file extension',
        function(done) {
    ...
    it('should throw an error trying to parse an invalid view',
        function(done) {

            var invalid_file = path.resolve(__dirname,
                "./mock/view_invalid.js");
            ...
            transformTools.runTransform(
                ...
                function(error, result) {
                    ...
                    var hasParseErrorMessage = error.message.indexOf(
                        'Parse Error:') > -1;
